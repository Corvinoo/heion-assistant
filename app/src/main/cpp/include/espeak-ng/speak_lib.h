...
/* Must be called before any synthesis functions are called.
   ...
   path: The directory which contains the espeak-ng-data-data directory, or NULL for the default location.
...
typedef struct {
	...
	const char *identifier;      // the filename for this voice within espeak-ng-data-data/voices
...
/* Reads the voice files from espeak-ng-data-data/voices and creates an array of espeak_VOICE pointers.
