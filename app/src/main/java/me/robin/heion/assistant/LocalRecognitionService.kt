...
class LocalRecognitionService : RecognitionService() {
    override fun onStartListening(recognizerIntent: android.content.Intent?, listener: Callback?) {
        Log.d("LocalAssistant", "Recognition service started listening")
    }

    override fun onCancel(listener: Callback?) {
        Log.d("LocalAssistant", "Recognition service cancelled")
    }

    override fun onStopListening(listener: Callback?) {
        Log.d("LocalAssistant", "Recognition service stopped listening")
    }
}
